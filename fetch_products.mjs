...
function getProducts() {
    return new Promise((resolve, reject) => {
        const options = {
            hostname: '5sim.net',
            path: '/v1/guest/products/any/any', // Try to get all products for 'any' country/operator
            method: 'GET',
            headers: {
...
(async () => {
    try {
        ...
        // Structure might be complex, let's see. 
        // Docs say: returns list of products.
        // Assuming object: { "google": { "Category": "...", "Qty": ... }, ... }
        ...
        fs.writeFileSync('products_list.json', JSON.stringify(keys, null, 2));
        console.log('Saved to products_list.json');
